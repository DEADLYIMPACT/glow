...
public class PaddlePong : MonoBehaviour
{
    ...
    private static PaddlePong paddle;

    public static PaddlePong Instance => paddle;
    ...
    void Update(){   
        if(Input.GetMouseButton(0) && !GameManagerPong.Instance.isShowingInst && Camera.main.ScreenToWorldPoint(new Vector2(0, Input.mousePosition.y)).y < 3.5 && Time.timeScale == 1){
